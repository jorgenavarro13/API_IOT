 ...
 */
async function getLogDistances(req,res){
    try{
        
        let query = constants.selectUltrasonic; //busca el query de temperaturas
 ...
 * @param {*} res 
 */
async function getDistancesBetweenDates(req,res){
    try{
        //later: validate session and find users tasks
        let query = constants.selectUltrasonicByDate;
 ...
 * @param {*} res 
 */
async function insertNewDistance(req,res){
    try{
        //later: validate session and find users tasks
        let query = constants.insertUltrasonic;
...
module.exports = {getLogDistances,getDistancesBetweenDates,insertNewDistance};
