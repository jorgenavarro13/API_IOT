 ...
 */
async function getLogFotoresistencias(req,res){
    try{
        
        let query = constants.selectFotoresistencia; //busca el query de temperaturas
 ...
 * @param {*} res 
 */
async function getFotorresistenciaBetweenDates(req,res){
    try{
        //later: validate session and find users tasks
        let query = constants.selectFotoresistenciaByDate;
 ...
 * @param {*} res 
 */
async function insertNewFotoresistencia(req,res){
    try{
        //later: validate session and find users tasks
        let query = constants.insertFotoresistencia;
        var fotoresistencia = req.body.valor;
        let params = [fotoresistencia];
...
module.exports = {getLogFotoresistencias,getFotorresistenciaBetweenDates,insertNewFotoresistencia};
